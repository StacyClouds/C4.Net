...
namespace C4.Net.Core.Tests
{
    public class ModelItemTests : AbstractTestBase
    {
        ...
        public void Test_GetAllTags_NoTagAdded_RequiredTagsAreReturned()
        {
            ...
            // Relationship.GetRequiredTags() == new List<string> { C4.Net.Tags.Relationship, C4.Net.Tags.Synchronous }
            Assert.Equal(new List<string> { C4.Net.Tags.Relationship }, relation.GetAllTags());
        }
        ...
        public void Test_GetAllTags_TagsAdded_AddedTagsAndRequiredTagsAreReturned()
        {
            ...
            // Relationship.GetRequiredTags() == new List<string> { C4.Net.Tags.Relationship, C4.Net.Tags.Synchronous }
            Assert.Equal(new List<string> { C4.Net.Tags.Relationship, "TagA","TagB" }, relation.GetAllTags());
        }
