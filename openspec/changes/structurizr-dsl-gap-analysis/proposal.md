...
- Add a formal gap analysis document comparing current C4.Net capabilities to Structurizr DSL feature areas.
...
### New Capabilities
- `dsl-gap-analysis`: A documented comparison of current C4.Net coverage versus Structurizr DSL, with a prioritized plan to close gaps.

## Impact

- Affected docs: `docs/C4-DSL-GAP-ANALYSIS.md`, `ROADMAP.md`, and likely `README.md`/index links.
- Affected code inventory: current C4.Net core, client, examples, and tests will be referenced as the baseline for the gap matrix.
