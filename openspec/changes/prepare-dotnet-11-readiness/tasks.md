...
- [x] 1.1 Add `net11.0` to `TargetFrameworks` in all primary library projects (`C4.Net.Core`, `C4.Net.Client`).
- [x] 1.2 Add `net11.0` to `TargetFrameworks` in all corresponding test and example projects.
- [x] 1.3 Run restore/build for `C4.Net.sln` and resolve any net11 target-resolution issues.

## 2. Modernize cryptography for forward compatibility

- [x] 2.1 Refactor `C4.Net.Client/Encryption/AesEncryptionStrategy.cs` to use non-obsolete PBKDF2 APIs instead of obsolete constructors.
