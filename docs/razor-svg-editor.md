...
Dragged elements and relationship label text snap to other diagram items when their horizontal or vertical positions come within 5 pixels. Relationship line nodes only snap to other line nodes.
