    ...
    public sealed class Relationship : ModelItem, IEquatable<Relationship>
    {
        ...
        public override List<string> GetRequiredTags()
        {
            if (LinkedRelationshipId == null) {
                ...
                tags.Add(C4.Net.Tags.Relationship);
                
                if (InteractionStyle == C4.Net.InteractionStyle.Synchronous)
                {
                    tags.Add(C4.Net.Tags.Synchronous);
                }
                else if (InteractionStyle == C4.Net.InteractionStyle.Asynchronous)
                {
                    tags.Add(C4.Net.Tags.Asynchronous);
                }
